...
constexpr DeletePetRequest::DeletePetRequest(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : ped_id_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string){}
...
const uint32_t TableStruct_pet_2fv1_2fpet_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::pet::v1::DeletePetRequest, ped_id_),
  ~0u,  // no _has_bits_
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_pet_2fv1_2fpet_2eproto = {
  false, false, 882, descriptor_table_protodef_pet_2fv1_2fpet_2eproto, "pet/v1/pet.proto", 
...
DeletePetRequest::DeletePetRequest(const DeletePetRequest& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ped_id_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    ped_id_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (!from._internal_ped_id().empty()) {
    ped_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_ped_id(), 
      GetArenaForAllocation());
  }
...
inline void DeletePetRequest::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  ped_id_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          auto str = _internal_mutable_ped_id();
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "pet.v1.DeletePetRequest.ped_id"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* DeletePetRequest::_InternalSerialize(
  ...
  // string ped_id = 1 [json_name = "pedId"];
  if (!this->_internal_ped_id().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_ped_id().data(), static_cast<int>(this->_internal_ped_id().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "pet.v1.DeletePetRequest.ped_id");
    target = stream->WriteStringMaybeAliased(
        1, this->_internal_ped_id(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:pet.v1.DeletePetRequest)
  ...
  if (!from._internal_ped_id().empty()) {
    _internal_set_ped_id(from._internal_ped_id());
  }
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
