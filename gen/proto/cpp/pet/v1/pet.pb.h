...
class DeletePetRequest final :
 ...
 public:
  ...
  // string ped_id = 1 [json_name = "pedId"];
  void clear_ped_id();
  const std::string& ped_id() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_ped_id(ArgT0&& arg0, ArgT... args);
  std::string* mutable_ped_id();
  PROTOBUF_NODISCARD std::string* release_ped_id();
  void set_allocated_ped_id(std::string* ped_id);
  private:
  const std::string& _internal_ped_id() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_ped_id(const std::string& value);
  std::string* _internal_mutable_ped_id();
  public:
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr ped_id_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_pet_2fv1_2fpet_2eproto;
};
// -------------------------------------------------------------------
...
inline void Pet::set_allocated_pet_id(std::string* pet_id) {
  ...
  if (pet_id_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    pet_id_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  }
...
// string ped_id = 1 [json_name = "pedId"];
inline void DeletePetRequest::clear_ped_id() {
  ped_id_.ClearToEmpty();
}
inline const std::string& DeletePetRequest::ped_id() const {
  // @@protoc_insertion_point(field_get:pet.v1.DeletePetRequest.ped_id)
  return _internal_ped_id();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void DeletePetRequest::set_ped_id(ArgT0&& arg0, ArgT... args) {
 
 ped_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:pet.v1.DeletePetRequest.ped_id)
}
inline std::string* DeletePetRequest::mutable_ped_id() {
  std::string* _s = _internal_mutable_ped_id();
  // @@protoc_insertion_point(field_mutable:pet.v1.DeletePetRequest.ped_id)
  return _s;
}
inline const std::string& DeletePetRequest::_internal_ped_id() const {
  return ped_id_.Get();
}
inline void DeletePetRequest::_internal_set_ped_id(const std::string& value) {
  
  ped_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* DeletePetRequest::_internal_mutable_ped_id() {
  
  return ped_id_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* DeletePetRequest::release_ped_id() {
  // @@protoc_insertion_point(field_release:pet.v1.DeletePetRequest.ped_id)
  return ped_id_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void DeletePetRequest::set_allocated_ped_id(std::string* ped_id) {
  if (ped_id != nullptr) {
    
  } else {
    
  }
  ped_id_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ped_id,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (ped_id_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    ped_id_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:pet.v1.DeletePetRequest.ped_id)
}
